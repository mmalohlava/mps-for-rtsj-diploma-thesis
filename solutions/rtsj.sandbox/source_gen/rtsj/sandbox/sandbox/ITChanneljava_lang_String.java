...
public class ITChanneljava_lang_String implements InterThreadChannel {
  ...
  public ITChanneljava_lang_String(int messageNumber) {
    poolSize = messageNumber;
    popPointer = EMPTY_POOL;
    pushPointer = 0;
    objects = new String[messageNumber];
  }
